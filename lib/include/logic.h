...
bool valid_check(int board[SIZE_BOARD][SIZE_BOARD], int row, int col, int num); /*
...
bool sudoku_solve(int board[SIZE_BOARD][SIZE_BOARD], int row, int col);/*
створює або розв'язує судоку методом бектрекінгу
функція розв'язує судоку з будьяким числом, якщо заходить в глухий кут - змінює число і продовжує розв'язок
*/
...
bool solution_check(int board[SIZE_BOARD][SIZE_BOARD]); /*перевіряє цілістність вже згенерованої дошки
